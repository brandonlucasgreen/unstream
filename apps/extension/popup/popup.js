...
const SOCIAL_ICONS = {
  instagram: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#E4405F" d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>',
  ...
  tiktok: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#E5E7EB" d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>',
  ...
  threads: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#E5E7EB" d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.589 12c.027 3.086.718 5.496 2.057 7.164 1.43 1.783 3.631 2.698 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.31-.71-.873-1.3-1.634-1.75-.192 1.352-.622 2.446-1.284 3.272-.886 1.102-2.14 1.704-3.73 
svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#F1680D" d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm-1.243 17.07V6.93L18.258 12l-7.5 5.07z"/></svg>',
};
...
const elements = {
  ...
  artistReleasesSection: document.getElementById('artist-releases-section'),
  artistReleasesToggle: document.getElementById('artist-releases-toggle'),
  artistReleases: document.getElementById('artist-releases'),
...
async function lookupSlug(artistName) {
  ...
  try {
    ...
    if (match) {
      // claimedSlug/knownSlug are real `artists.slug` values. `match.id` is not — it is
      // 'known-<slug>'/'claimed-<slug>' for stored cards and a platform-derived id otherwise —
      // so it is only a last resort, kept so behaviour doesn't regress against an older deploy.
      const slug = match.claimedSlug || match.knownSlug || match.id;
      if (slug) {
        // Persist to cache
...
function renderResults(results) {
  ...
  // The artist's page slug, for the releases section. `knownSlug` is what makes this work for
  // artists who haven't claimed a page — the vast majority — and it only started coming back from
  // /api/search/sources alongside this feature.
  const pageSlugResult = results.find(r => r.type === 'artist' && (r.claimedSlug || r.knownSlug));
  setArtistReleasesSlug(pageSlugResult?.claimedSlug || pageSlugResult?.knownSlug || null);
...
// --- Artist releases -------------------------------------------------------
//
// Finding an artist should lead to their records, not stop at a row of platform links. Before
// this, the only route to a buying guide was a release *alert* — which needs the artist saved, a
// scheduled check to have run, and the release to be new — so an album from last year was
// unreachable in the extension entirely.

/** Slug of the artist currently shown, or null when we can't place them. */
let artistReleasesSlug = null;
/** Cached /api/artist-page responses, keyed by slug, for this popup session. */
const artistPageCache = new Map();

function setArtistReleasesSlug(slug) {
  artistReleasesSlug = slug;

  // Collapse whatever the last artist left open — the panel is reused.
  elements.artistReleases.classList.add('hidden');
  elements.artistReleases.replaceChildren();
  elements.artistReleasesToggle.setAttribute('aria-expanded', 'false');

  // No slug means no page to load. An unverified search result is the usual case; nothing
  // persists those, so /api/artist-page would 404.
  elements.artistReleasesSection.classList.toggle('hidden', !slug);
}

async function fetchReleaseDetail(artistSlug, releaseSlug) {
  const response = await fetch(
    `${API_BASE}/release/${encodeURIComponent(artistSlug)}/${encodeURIComponent(releaseSlug)}`
  );
  if (!response.ok) throw new Error(`HTTP ${response.status}`);
  return response.json();
}

async function toggleArtistReleases() {
  const slug = artistReleasesSlug;
  if (!slug) return;

  const panel = elements.artistReleases;
  const isOpen = !panel.classList.contains('hidden');
  if (isOpen) {
    panel.classList.add('hidden');
    elements.artistReleasesToggle.setAttribute('aria-expanded', 'false');
  ...
  panel.classList.remove('hidden');
  elements.artistReleasesToggle.setAttribute('aria-expanded', 'true');

  if (artistPageCache.has(slug)) {
    renderArtistReleases(panel, artistPageCache.get(slug), slug, fetchReleaseDetail, openReleaseUrl);
    return;
  }

  panel.replaceChildren(guideMessage('Loading releases…'));
  try {
    const response = await fetch(`${API_BASE}/artist-page?slug=${encodeURIComponent(slug)}`);
    // A 404 is a real answer: we have no page for them. Anything else means we don't know, and
    // must not render as "they have no releases".
    if (response.status === 404) {
      panel.replaceChildren(guideMessage("We don't have a page for this artist yet."));
      return;
    }
    if (!response.ok) throw new Error(`HTTP ${response.status}`);

    const page = await response.json();
    artistPageCache.set(slug, page);
    renderArtistReleases(panel, page, slug, fetchReleaseDetail, openReleaseUrl);
  } catch (error) {
    console.error('[Unstream] Artist page fetch failed:', error);
    panel.replaceChildren(guideMessage("Couldn't load releases just now."));
  }
}
...
function setupEventListeners() {
  ...
  elements.artistReleasesToggle.addEventListener('click', toggleArtistReleases);
