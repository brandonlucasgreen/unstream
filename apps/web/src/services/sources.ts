...
export const sources: Record<SourceId, Source> = {
  ...
  liberapay: {
    id: 'liberapay',
    name: 'Liberapay',
    description: 'Recurring donations platform',
    color: '#F6C915',
    icon: '🤝',
    category: 'patronage',
    hasEmbed: false,
...
export const sourceCategories = {
  ...
  official: {
    ...
    sources: ['officialsite', 'wikipedia'] as SourceId[],
  },
  social: {
    name: 'Social',
    description: 'Artist social media profiles',
    sources: ['instagram', 'facebook', 'tiktok', 'youtube', 'threads', 'bluesky', 'mastodon', 'peertube', 'newsletter'] as SourceId[],
  },
  curated: {
    name: 'Links',
