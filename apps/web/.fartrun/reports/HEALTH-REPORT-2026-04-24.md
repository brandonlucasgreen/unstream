...
Scanned: 2026-04-24 06:52
Total findings: 86 (actionable: 71)

🟡 medium: 21 | 🔵 low: 50 | ℹ️ info: 15
...
2. extract duplicates (4 items)
3. split large files (3 items)
...
- [ ] **Duplicate: src/components/PasswordSection.tsx ↔ src/pages/ResetPasswordPage.tsx (12 lines)**
  ...
  - **Fix (Python docs):**
    ...
    ```
    --------------------------------
    ### Extract Function Parameter Information with getfullargspec in Python
...
- [ ] **Extract reusable component: <TextXsTextTextMuted />**
  - <p class='text-xs text-text-muted'> appears 13 times in 7 files: src/components/PasswordSection.tsx, src/components/ArtistAnalytics.tsx, src/pages/ClaimReviewStep.tsx.
...
- [ ] **Extract reusable component: <TextSmTextTextMuted />**
  - <p class='text-sm text-text-muted'> appears 12 times in 8 files: src/pages/ClaimReviewStep.tsx, src/pages/ArtistLoginPage.tsx, src/pages/ClaimManualReviewSubmittedStep.tsx.
...
- [ ] **Extract reusable component: <FlexItemsStartGap4 />**
  - <div class='flex items-start gap-4'> appears 8 times in 4 files: src/pages/ExtensionPage.tsx, src/pages/ClaimReviewStep.tsx, src/pages/ImportPage.tsx.
...
- [ ] **Orphan: server/shared-types.ts**
  - server/shared-types.ts — nobody imports it, not an entry point.

- [ ] **Orphan: src/pages/ClaimPageTypes.ts**
  - src/pages/ClaimPageTypes.ts — nobody imports it, not an entry point.

- [ ] **Orphan: src/main.tsx**
  - src/main.tsx — nobody imports it, not an entry point.
...
- [ ] **Hardcoded url: src/pages/ClaimWebsiteStep.tsx:21**
  - src/pages/ClaimWebsiteStep.tsx:21 — https://linktr.ee/yourname.
...
- [ ] **Big commit: ac6b052 (897 lines)**
  - Commit 'refactor(claim): split ClaimPage.tsx into focused sub-components' changed 897 lines.
...
- **Project Map**: In your project: 105 files. Most common: .tsx (47). This is just context — now you know what's inside.
...
- **Session: 1 commits, ~11 files touched**: Last 8 hours: 1 commits, ~11 files modified.
