...
const TAKE_COUNT = 1000; // Take the next N after skipping
...
// Fetch a larger pool so we can skip the top 1000 and still have 1000+ left.
// Lower sitelink thresholds to reach deeper into the mid-tier.
