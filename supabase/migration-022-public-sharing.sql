...
--
-- Round-2 review #11 closed the anon-UUID leak by adding migration 023 (DROP POLICY),
-- which actually removes the policy from production. See
-- migration-023-drop-anon-usernames-policy.sql.
