    ...
    <footer className="border-t border-border py-6 px-4">
      <div className="max-w-4xl mx-auto flex flex-col items-center justify-center gap-3 text-text-secondary text-sm">
        ...
        <nav className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
          <Link to="/artists" className="hover:text-text-primary transition-colors">Artist index</Link>
          <span className="text-text-muted/40 text-xs">&#x2022;</span>
          <Link to="/artist-login" className="hover:text-text-primary transition-colors">Login</Link>
          <span className="text-text-muted/40 text-xs">&#x2022;</span>
          <a
