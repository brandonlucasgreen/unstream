            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-text-muted mb-3">
                  The Mac app and browser extensions detect what's playing automatically and keep track of artists you want to support. Saved artist lists &amp; new release alerts included with the <a href="https://bgreenlol.lemonsqueezy.com/checkout/buy/d4e127a7-2cef-4013-80b8-5d0de691f332" target="_blank" rel="noopener noreferrer" className="text-accent-primary hover:underline">Unstream Yearly Pass</a> ($4.99/year).
                </p>
